...
if (isset($_POST["fileinput"]) && isset($_POST["name"]) && isset($_POST["price"]) &&
    isset($_POST["stock"]) && isset($_POST["description"]) && isset($_POST["category"])){
    if(!empty($_POST["fileinput"]) &&!empty($_POST["name"]) && !empty($_POST["price"]) && !empty($_POST["stock"]) &&
        ...
        $qry = "INSERT INTO `products` (`name`, `price`, `stock_quantity`, `description`,`category`, `image_url`)".
            ...
            <div class="tm-bg-primary-dark tm-block tm-block-h-auto">
                ...
                <div class="row tm-edit-product-row">
                    <div class="col-xl-6 col-lg-6 col-md-12">
                        <form action="admin_add-product.php" class="tm-edit-product-form" method="post">
